         ...
         if (err){
            ...
            try {
                const {
                    ...
                    const query =`CALL SP_MOD_SEGURIDAD('TBL_MS_PREGUNTAS', 'I', '1', 'Admins', '1', '0', '0','1', 'solo consultas','ACTIVO','0', '2023-07-01', '0', '${PREGUNTA}', 'CAMPEON', '1', 'ol', 'nj', 'bgv', 'S', 'S', 'N', '1', '2023-07-01 16:06:00', 'Mantenimiento predictivo', '1', '100', '0', 'Parametro', 'Descripcion', '1', '0', '0');`;
                    mysqlConnection.query(query , (err , rows , fields) =>{
                    if(!err){
         ...
         if (err){
            ...
            try {
                const {
                    ...
                    console.log(req.body)
                    const query =`CALL SP_MOD_SEGURIDAD('TBL_MS_PREGUNTAS', 'U', '1', 'Admins', '1', '0', '0','1', 'solo consultas','ACTIVO','0', '2023-07-01', '${COD_PREGUNTA}', '${PREGUNTA}', 'CAMPEON', '1', 'ol', 'nj', 'bgv', 'S', 'S', 'N', '1', '2023-07-01 16:06:00', 'Mantenimiento predictivo', '1', '100', '0', 'Parametro', 'Descripcion', '1', '0', '0');`;
                    mysqlConnection.query(query , (err , rows , fields) =>{
                    if(!err){
